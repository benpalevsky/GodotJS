#ifndef GODOTJS_TESTS_JSB_ESM_GODOT_RUNTIME_H
#define GODOTJS_TESTS_JSB_ESM_GODOT_RUNTIME_H
...
namespace jsb::tests
{
    TEST_CASE("[jsb]esm godot synthetic module")
    {
        ...
        CHECK(env->load("tests/esm/godot_imports", &mod) == OK);
        CHECK(mod != nullptr);
